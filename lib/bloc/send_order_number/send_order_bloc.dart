...
class SendOrderBloc extends Bloc<SendOrderEvent, SendOrderState> {
  ...
  Stream<SendOrderState> loadSendOrderToState(
    String email,
    String domainName,
  ) async* {
    try {
      ...
      var order = await repository.sendOrderNumber(
          "unstoppabledomains", email, jsonStringParse(domainName));
    ...
    String jsonString = jsonEncode({
      "order": {
        "domains": [
          {
            "name": "$name",
            "owner": {"address": "0x033dc48B5dB4CA62861643e9D2C411D9eb6D1975"},
            "resolution": {
              "crypto": {
                "ZIL": {"address": "0xe568f2BB42A77F6508911290d581B3Af107b1e4B"},
                "ETH": {"address": "0x20B4564DEB7AF89ece828d843D0Ac2c16934a23e"}
              }
            }
          }
        ],
